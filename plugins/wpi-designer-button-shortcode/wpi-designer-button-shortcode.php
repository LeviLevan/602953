...
class WPiDesignerButtonShortcode{
	...
	public function __construct(){	
		define( 'WPI_DESIGNER_BUTTON_SHORTCODE', '2.6.0' );
	...
	public function designer_button($atts_input, $content=""){
		...
		$defaults=array("id"=>"", "style_id"=>"", "slide_id"=>"", "share_id"=>"", "twin_id"=>"", "smart_id"=>"", 'link'=>'#', 'text'=>'button', "target"=>"", "icon"=>"", "display"=>false, "icon_position"=>"left", "rel" => "", "on_click" => "", "button_type" =>"", "popup" =>"", "popup_type" =>"", "menu" =>"");
